...
% the main Program for feature extraction and feature selection

% load a mat file that contains left-most ORFs sequences with gc content
load('left_orfSeqs_2528.mat')
...
%save files
save('Test_orfSeqs_2528.mat','all_features','-v7.3')
csvwrite('Test_orfSeqs_2528.csv',all_features)
